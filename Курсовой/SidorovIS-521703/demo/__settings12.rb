...
=end
puts " -< Герои Властелина Кольца -vs- Герои Гарри Поттера v. 0.0.1 >- ".to_center()
=begin
 class Settings
  including:
  function Init()
       ...
       { :Players =>
         {
            ...
            "Двалин" => 	{ :Speed => 4 },
            "Леголаз" => 	{ :Speed => 3 },
            "Фродо" => 		{ :Speed => 8, :ProtectTactic => :Go4, :Go4 => "Арагорн" },
            "Сэм" => 		{ :Speed => 4 },
            "Гендальф белый" => { :Speed => 3 },
            "Гендальф серый" => { :Speed => 2 },
            "Саурон" =>		{ :Speed => 1 },
            "Бильбо Бэггинс" => { :Speed => 8 },
            "Мэрри" => 		{ :Speed => 1 },
            "Пиппин" =>		{ :Speed => 3 },
            "Арагорн" =>	{ :Speed => 5 },
            "Элронд" =>		{ :Speed => 4 },
