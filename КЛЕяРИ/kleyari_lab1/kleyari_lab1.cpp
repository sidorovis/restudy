...
BEGIN_MESSAGE_MAP(Ckleyari_lab1App, CWinApp)
...
Ckleyari_lab1App::Ckleyari_lab1App()
{
	// TODO: 在此加入建構程式碼，
...
// 僅有的一個 Ckleyari_lab1App 物件

Ckleyari_lab1App theApp;


// Ckleyari_lab1App 初始設定

BOOL Ckleyari_lab1App::InitInstance()
{
