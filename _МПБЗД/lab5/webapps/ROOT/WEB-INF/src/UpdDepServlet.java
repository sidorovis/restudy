...
public class UpdDepServlet extends HttpServlet {
        ...
        throws IOException, ServletException 
	{
		...
		try 
		{
			...
			String old_dep_title = request.getParameter("old_title");
			String dep_title = request.getParameter("title");
			String dep_about = request.getParameter("about");

			Object[] params = new Object[3];
			params[0] = (Object)old_dep_title;
			params[1] = (Object)dep_title;
			params[2] = (Object)dep_about;
			int result = ((Integer)call.invoke("upd_dep",params)).intValue();
			if (result == -1)
